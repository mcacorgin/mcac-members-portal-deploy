...
> {
  ...
  // Sandeep's 2026-08-20 decision retired the directory opt-out. Every
  // approved member is discoverable; contact fields remain independently
  // projected by projectContact.
