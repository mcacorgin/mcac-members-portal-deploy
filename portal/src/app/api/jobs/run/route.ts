...
// Background jobs entry point: post expiry, attachment retention, and outbox
// email delivery. Vercel Cron calls GET with CRON_SECRET. Other schedulers
...
async function runJobs() {
  ...
  return NextResponse.json({ expired, retention, ...outbox });
}
